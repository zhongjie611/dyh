...
import static com.bdqn.fastweixin.util.BeanUtil.isNull;
import static com.bdqn.fastweixin.util.BeanUtil.nonNull;
import static com.bdqn.fastweixin.util.StrUtil.isNotBlank;
...
import com.bdqn.fastweixin.message.req.BaseReqMsg;
import com.bdqn.fastweixin.message.req.LocationEvent;
import com.bdqn.fastweixin.message.req.MenuEvent;
import com.bdqn.fastweixin.util.CollectionUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.bdqn.fastweixin.handle.EventHandle;
import com.bdqn.fastweixin.handle.MessageHandle;
import com.bdqn.fastweixin.message.BaseMsg;
import com.bdqn.fastweixin.message.TextMsg;
import com.bdqn.fastweixin.message.aes.AesException;
import com.bdqn.fastweixin.message.aes.WXBizMsgCrypt;
import com.bdqn.fastweixin.message.req.BaseEvent;
import com.bdqn.fastweixin.message.req.BaseReq;
import com.bdqn.fastweixin.message.req.EventType;
import com.bdqn.fastweixin.message.req.ImageReqMsg;
import com.bdqn.fastweixin.message.req.LinkReqMsg;
import com.bdqn.fastweixin.message.req.LocationReqMsg;
import com.bdqn.fastweixin.message.req.QrCodeEvent;
import com.bdqn.fastweixin.message.req.ReqType;
import com.bdqn.fastweixin.message.req.TextReqMsg;
import com.bdqn.fastweixin.message.req.VideoReqMsg;
import com.bdqn.fastweixin.message.req.VoiceReqMsg;
import com.bdqn.fastweixin.util.MessageUtil;
import com.bdqn.fastweixin.util.SignUtil;
...
public abstract class WeixinSupport {
    ...
    protected String processRequest(HttpServletRequest request) {
        ...
        if (msgType.equals(ReqType.EVENT)) {
            ...
            } else if (eventType.equals(EventType.CLICK) || "scancode_waitmsg".equals(eventType)) {
                String eventKey = reqMap.get("EventKey");
                log.debug("eventKey:{}"+ eventKey);
