...
import com.bdqn.fastweixin.api.entity.CustomAccount;
import com.bdqn.fastweixin.api.response.BaseResponse;
import com.bdqn.fastweixin.api.response.GetCustomAccountsResponse;
import com.bdqn.fastweixin.exception.WeixinException;
import com.bdqn.fastweixin.message.ImageMsg;
import com.bdqn.fastweixin.message.MusicMsg;
...
import com.bdqn.fastweixin.message.VideoMsg;
import com.bdqn.fastweixin.message.VoiceMsg;
...
public class CustomAPI extends BaseAPI {
    ...
    private static final Log LOG = LogFactory.getLog(CustomAPI.class);
