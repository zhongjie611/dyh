...
import com.bdqn.fastweixin.api.enums.MediaType;
...
import com.bdqn.fastweixin.api.response.DownloadMediaResponse;
import com.bdqn.fastweixin.api.response.UploadMediaResponse;
import com.bdqn.fastweixin.util.NetWorkCenter;
import com.bdqn.fastweixin.util.StreamUtil;
...
public class MediaAPI extends BaseAPI {
    ...
    private static final Log LOG = LogFactory.getLog(MediaAPI.class);
