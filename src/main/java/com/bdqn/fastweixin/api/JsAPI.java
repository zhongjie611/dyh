...
import com.bdqn.fastweixin.api.response.GetSignatureResponse;
import com.bdqn.fastweixin.util.BeanUtil;
import com.bdqn.fastweixin.util.JsApiUtil;
...
public class JsAPI extends BaseAPI {
    ...
    private static final Log LOG = LogFactory.getLog(JsAPI.class);
