...
import com.bdqn.fastweixin.api.response.GetUserCumulateResponse;
import com.bdqn.fastweixin.api.response.GetUserShareHourResponse;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import com.bdqn.fastweixin.api.config.ApiConfig;
import com.bdqn.fastweixin.api.response.BaseResponse;
import com.bdqn.fastweixin.api.response.GetArticleSummaryResponse;
import com.bdqn.fastweixin.api.response.GetArticleTotalResponse;
import com.bdqn.fastweixin.api.response.GetInterfaceSummaryHourResponse;
import com.bdqn.fastweixin.api.response.GetInterfaceSummaryResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgDistMonthResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgDistResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgDistWeekResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgHourResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgMonthResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgResponse;
import com.bdqn.fastweixin.api.response.GetUpstreamMsgWeekResponse;
import com.bdqn.fastweixin.api.response.GetUserReadHourResponse;
import com.bdqn.fastweixin.api.response.GetUserReadResponse;
import com.bdqn.fastweixin.api.response.GetUserShareResponse;
import com.bdqn.fastweixin.api.response.GetUserSummaryResponse;
...
public class DataCubeAPI extends BaseAPI {
    ...
    private static final Log LOG = LogFactory.getLog(DataCubeAPI.class);
